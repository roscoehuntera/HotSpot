...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $error["message"] = "Submission failed: Destination name already in use.";
    } else {
        if (strlen($recommend) == 0) {
            $query = "INSERT INTO destinations (name,img_url) VALUES ('$name','$img')";
        } else {
            $query = "INSERT INTO destinations (name,img_url,quiz_recommend) VALUES ('$name','$img','$recommend')";
        }
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $error["message"] = "Submission succeeded: Destination was successfully added.";
        } else {
            $error["class"] = "alert-error";
...
<body>
    ...
    <main class="container-custom">
        <h1 class="text-center">Add A Destination</h1>
        <form class="form-custom" action="" method="POST">
            <label for="name">
                Name:
                <input type="text" name="name" id="name" placeholder="Miami, Florida" maxlength="60" required />
            </label>
            <label for="img">
                Image URL:
            ...
            <label for="recommend">
                Quiz options, separated by a comma (optional)
                <input type="text" name="recommend" id="recommend" maxlength="100" placeholder="1a,1c,2b,2c,3b">
            </label>
