...
<body>
    ...
    <main class="container-custom">
        <h1 class="text-center"><?php echo $current_destination["name"]; ?></h1>
        <div class="all-destinations-container">
            <a href="./places.php?place=stay&id=<?php echo $current_destination["id"] ?>" class="single-destination-card">
                <img src="https://media-cdn.tripadvisor.com/media/photo-s/16/1a/ea/54/hotel-presidente-4s.jpg" />
                <p>Places To Stay</p>
            </a>
            <a href="./places.php?place=eat&id=<?php echo $current_destination["id"] ?>" class="single-destination-card">
                <img src="https://www.reasonwhy.es/sites/default/files/take_a_restaurant.jpg" />
                <p>Places To Eat</p>
            </a>
            <a href="./places.php?place=fun&id=<?php echo $current_destination["id"] ?>" class="single-destination-card">
                <img src="../assets/Blogpost1/Barbados1.jpg" />
                <p>Activities & Fun</p>
            </a>
        </div>
        <?php
            if ($logged) {
                echo '<div class="text-center" style="margin-bottom: 2rem;"><a href="./add-place.php?id='.$current_destination["id"].'"><button class="btn">Add A Place</button></a></div>';
            }
        ?>
    </main>
