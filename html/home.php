...
$three_destinations = array_slice($destinations, 0, 3);
...
<head>
    ...
    <link rel="stylesheet" href="style.css?dummy=d22f" />
...
<body>
    ...
    <nav class="nav">
        <div class="nav-menu flex-row">
            <div class="nav-brand">
                <a href="#" class="text-gray">HotSpot</a>
            </div>
    ...
    <section class="section-custom container-custom">
        <h1>Some destinations you should definitely check:</h1>
        <div class="destinations">
            <?php
                foreach ($three_destinations as $destination) {
                    echo '
                    <a href="./single-destination.php?id='.$destination["id"].'" class="destination-card">
